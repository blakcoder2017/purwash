...
import { changePassword, updateProfile, verifyMomo } from "../api/partner";
...
const ProfileScreen: React.FC = () => {
  ...
  const handleVerifyMomo = async () => {
    setMessage(null);
    try {
      await verifyMomo({ ...momoForm, businessName: profileForm.businessName });
      await refreshProfile();
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.meta}>Business: {user.businessName || "-"}</Text>
      ...
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} placeholder="Business name" value={profileForm.businessName} onChangeText={(v) => setProfileForm({ ...profileForm, businessName: v })} />
