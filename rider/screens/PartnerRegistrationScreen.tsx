...
const PartnerRegistrationScreen: React.FC<{ role: 'rider' | 'partner' }> = ({ role }) => {
  ...
  const renderStepTwo = () => (
    <div className="space-y-4">
      ...
      <textarea
        ...
        onChange={(e) => setStepTwoData({ ...stepTwoData, address: e.target.value })}
    ...
    <div className="min-h-screen bg-primary flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-300">{role === 'rider' ? 'Rider' : 'Partner'} Registration</p>
